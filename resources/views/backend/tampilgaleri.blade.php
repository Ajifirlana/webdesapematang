  ...
  <div class="m-portlet">
    ...
    <div class="m-portlet__body">
       <div align="center" class="m-portlet__head-title">
          ...
          <h3 class="m-portlet__head-text">Tampil Galeri</h3>
        </div>
      <div class="col-md-12">
...
<thead>
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">{{ $galeri->caption }}</th>
      <th scope="row"><img src="../../uploads/{{$galeri->image}}"  class="card-img rounded-0" width="100px" height="300px"></th>
